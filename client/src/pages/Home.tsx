...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ed] text-[#2c2b28] selection:bg-[#d4a373] selection:text-[#2c2b28]">
        ...
        <section className="mx-auto grid max-w-[1320px] gap-8 px-5 pb-16 pt-7 lg:grid-cols-[0.92fr_1.08fr] lg:gap-12 lg:px-10 lg:pb-24 lg:pt-10">
          <div className="flex flex-col justify-center py-8 lg:py-16">
            ...
            <div className="mt-16 flex items-center gap-8 border-t border-[#2c2b28]/15 pt-6 text-[#6e6860]">
              ...
              <div><span className="block font-serif text-2xl text-[#2c2b28]">100%</span><span className="text-[9px] font-semibold uppercase tracking-[0.17em]">Cotton cord</span></div>
              <div><span className="block font-serif text-2xl text-[#2c2b28]">∞</span><span className="text-[9px] font-semibold uppercase tracking-[0.17em]">Good energy</span></div>
            </div>
          </div>
        ...
        <section id="catalogue" className="scroll-mt-24 border-y border-[#2c2b28]/10 bg-[#ebe2d7]">
          <div className="mx-auto max-w-[1320px] px-5 py-16 lg:px-10 lg:py-24">
            ...
            <div className="mb-10 flex flex-wrap items-center gap-2 border-b border-[#2c2b28]/15 pb-5">
              ...
              <span className="ml-auto hidden text-[10px] font-semibold uppercase tracking-[0.15em] text-[#938a7e] sm:block">{filteredProducts.length} pieces</span>
            </div>
              ...
              {filteredProducts.map((product, index) => (
                <article key={product.id} className="group" style={{ animationDelay: `${index * 70}ms` }}>
                  ...
                  <div className="flex items-start justify-between gap-3 pt-4">
                    <div><h3 className="font-serif text-[22px] tracking-[-0.04em]">{product.name}</h3><p className="mt-1 text-[12px] leading-5 text-[#80766d]">{product.description}</p></div>
        ...
        <section id="story" className="scroll-mt-24 mx-auto grid max-w-[1320px] gap-12 px-5 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24 lg:px-10 lg:py-28">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-10 grid max-w-[480px] grid-cols-2 gap-8 border-t border-[#2c2b28]/15 pt-6">
              ...
              <div><p className="font-serif text-3xl tracking-[-0.05em]">02</p><p className="mt-2 text-[10px] font-semibold uppercase leading-4 tracking-[0.15em] text-[#80776c]">Materials chosen to last</p></div>
            </div>
          </div>
        </section>
        ...
        <section id="care" className="scroll-mt-24 bg-[#2c2b28] text-[#f7f3ed]">
          <div className="mx-auto grid max-w-[1320px] gap-12 px-5 py-16 lg:grid-cols-[0.75fr_1.25fr] lg:items-center lg:px-10 lg:py-20">
            ...
            <div className="grid gap-px overflow-hidden rounded-[1.5rem] border border-[#f7f3ed]/15 bg-[#f7f3ed]/15 sm:grid-cols-3">
              {[{ icon: PackageCheck, title: "Packed with care", text: "Wrapped in recycled paper, ready to gift." }, { icon: Leaf, title: "Natural materials", text: "Unbleached cotton, beechwood and brass." }, { icon: MessageCircle, title: "Here to help", text: "Questions? We reply within one working day." }].map(({ icon: Icon, title, text }) => <div key={title} className="bg-[#363330] p-6"><Icon size={20} strokeWidth={1.5} className="mb-9 text-[#d4a373]" /><h3 className="font-serif text-xl tracking-[-0.04em]">{title}</h3><p className="mt-2 text-xs leading-5 text-[#b9aea1]">{text}</p></div>)}
            </div>
          </div>
        </section>
      ...
      <aside className={`fixed bottom-0 right-0 top-0 z-[60] flex w-full max-w-[460px] flex-col bg-[#f7f3ed] shadow-2xl transition-transform duration-300 ease-out ${cartOpen ? "translate-x-0" : "translate-x-full"}`} aria-label="Shopping cart">
